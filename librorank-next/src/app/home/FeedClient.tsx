...
interface Props {
  ...
  usuarioId: number
  formatFecha: (tipo: string, titulo?: string | null, detalle?: string | null) => string
}

export default function FeedClient({ feedInicial, usuarioId, formatFecha }: Props) {
          ...
          <div className="d-flex gap-3">
            <div className="feed-user-img">
              <img
                ...
                onError={(e) => { (e.target as HTMLImageElement).src = '/img/personajes/personaje_2.png' }}
              />
            </div>
            <div className="flex-grow-1">
              ...
              <div className="feed-content my-2 text-white opacity-75">
                {formatFecha(act.tipo_actividad, act.titulo, act.detalle)}
              </div>
              {act.portada_url && (
